namespace MyApplication
{
    ...
    public static class SongLibrary
    {
        public static List<Song> AllSongs { get; } = new List<Song>
        {
            ...
            new Song
            {
                Title = "Billie Jean", Artist = "Michael Jackson", Genre = "Pop", Time = new TimeSpan(0, 4, 54)
            },
            new Song
            {
                Title = "Smells Like Teen Spirit", Artist = "Nirvana", Genre = "Grunge", Time = new TimeSpan(0, 5, 1)
            },
            new Song { Title = "Hey Jude", Artist = "The Beatles", Genre = "Rock", Time = new TimeSpan(0, 7, 11) },
            new Song
            {
                Title = "Like a Rolling Stone", Artist = "Bob Dylan", Genre = "Folk Rock", Time = new TimeSpan(0, 6, 13)
            },
            ...
            new Song
            {
                Title = "Blinding Lights", Artist = "The Weeknd", Genre = "Synthpop", Time = new TimeSpan(0, 3, 20)
            },
            new Song
            {
                Title = "Uptown Funk", Artist = "Mark Ronson ft. Bruno Mars", Genre = "Funk",
                Time = new TimeSpan(0, 4, 30)
            },
            ...
            new Song
            {
                ...
                Time = new TimeSpan(0, 5, 56)
            },
            new Song
            {
                Title = "Thinking Out Loud", Artist = "Ed Sheeran", Genre = "Pop", Time = new TimeSpan(0, 4, 41)
            },
            ...
            new Song
            {
                Title = "Stairway to Heaven", Artist = "Led Zeppelin", Genre = "Rock", Time = new TimeSpan(0, 8, 2)
            },
            new Song
            {
                Title = "Bad Guy", Artist = "Billie Eilish", Genre = "Electropop", Time = new TimeSpan(0, 3, 14)
            },
            new Song
            {
                Title = "Radioactive", Artist = "Imagine Dragons", Genre = "Alternative Rock",
                Time = new TimeSpan(0, 3, 6)
            },
